...
// ============================================================
// 1. RATE LIMITING В SUPABASE (надёжно)
// ============================================================
...
async function checkRateLimit(ip) {
    ...
    try {
        ...
        const res = await fetch(`${SUPABASE_URL}/rest/v1/rate_limits?ip=eq.${ip}`, {
            headers: {
        ...
        // Если что-то пошло не так, пропускаем (fallback)
        return { allowed: true };
    }
}
